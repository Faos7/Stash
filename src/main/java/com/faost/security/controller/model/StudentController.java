...
public class StudentController {
    ...
    public ModelAndView getStudentPage(@PathVariable Long id) {
        ...
        return new ModelAndView("student", "student", userService.getUserById(id)
    ...
    public ModelAndView getStudentsPage() {
        ...
        return new ModelAndView("students", "students", userService.getAllUsersWithSpecifiedRole("student"));
    }
